...
- What, in your opinion, is an important part of code reviews? That is, what is
  ...
  # I look for a coherent work follow and a well documented project


- We have an awful lot of computers here, and it gets pretty confusing with
  slightly different things running on all of them. How could containers help us
  improve this situation?
  # Containers would assure that our work can run in any computer don't matter the
  # set up by sending along with our code everything it needs to run properly
  # (Operating system, matching tool versions and any other resource).
